                                                        ...
                                                        <div class="col-lg-4 col-md-5">
                                                            <div class="cart-total-area">
                                                                ...
                                                                <div class="process-checkout-btn text-end">
                                                                    <a class="btn-def btn2" href="checkout.php">Process To
                                                                        Checkout</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="contact-text right-side">
                                                                        ...
                                                                        <form method="post" action="#">
                                                                            ...
                                                                            <div class="d-grid gap-2 ">
                                                                                <button class="btn btn-dark btn-sm mt-2" type="submit" name="submit">Order</button>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                </div>
...
<!-- Mirrored from template.hasthemes.com/clothing/clothing/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Feb 2023 11:05:05 GMT -->
</html>